...
/**
 * This page rank uses the code give by apache spark examples and code snippets from recitation.
 * The sum of the page ranks do NOT sum up to 1 as it was taught in class
 */
